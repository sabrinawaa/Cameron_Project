...
quad_length = 0.3
k1_1, k1_2, k1_3, k1_4 = -75,-75,0,0 #<75
drift_l = 0.2
dir = '/Users/sabrinawang/Desktop/Cameron_Project/'
name = '4quad'
output_filename = "4quad_k1=10_10_10_10"
n_particles = 1e5 #1e5
dose_depth = 100

R = four_quads(quad_length, k1_1, k1_2, k1_3, k1_4, drift_l, n_particles, 200)


# R = np.loadtxt(f"RFT_k1s={k1_1}_{k1_2}_{k1_3}_{k1_4}_N={n_particles}.txt") 

# for s1_depth in [0.95]:
#     for s2_depth in [3]:
#         for s2_radius in [3]:
